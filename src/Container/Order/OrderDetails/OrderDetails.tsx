                        ...
                        <Row className="mt-4" key={id}>
                            <Col md={3}>
                                <div className="image_background_color">
                                    <img className='card_image' width={100} height={100} src={card_image} />
                                </div>
                            </Col>
                            ...
                            <Col md={9}>
                                <div className="card_inner_text">
                                    <div>
                                        <b className='card_head'>WOMENS SCRUB TOP</b>
                                    </div>

                                    <div>
                                        <small className="dollar_sign">$</small>
                                        <small className="dress_price">
                                            {price}
                                        </small>
                                    </div>
